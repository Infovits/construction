        ...
        <div class="w-full max-w-6xl">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                ...
                <div class="p-6">
                    ...
                    <form action="<?= base_url('admin/materials/create') ?>" method="POST" id="materialForm">
                        <?= csrf_field() ?>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="item_code" id="item_code" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" value="<?= old('item_code') ?>" required>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    nameInput.addEventListener('input', function() {
        if (!itemCodeInput.value) { // Only auto-generate if item code field is empty

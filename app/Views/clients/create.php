...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border">
        <form action="<?= base_url('admin/clients/store') ?>" method="post" class="p-6 space-y-6">
            <?= csrf_field() ?>
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <textarea id="address" name="address" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"><?= old('address') ?></textarea>
                    </div>
                </div>

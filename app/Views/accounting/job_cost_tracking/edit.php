...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Edit Job Cost Entry</h1>
            <p class="text-gray-600 mt-1">Update cost entry details</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-lg">
        <form action="<?= base_url('admin/accounting/job-cost-tracking/' . $jobCost['id']) ?>" method="post" class="p-6">
            <?= csrf_field() ?>
                ...
                <div>
                    ...
                    <select name="project_id" id="project_id" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <?php foreach ($projects as $project): ?>
                            <option value="<?= $project['id'] ?>" <?= $jobCost['project_id'] == $project['id'] ? 'selected' : '' ?>>
                ...
                <div>
                    ...
                    <select name="cost_code_id" id="cost_code_id" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <?php foreach ($costCodes as $code): ?>
                            <option value="<?= $code['id'] ?>" <?= $jobCost['cost_code_id'] == $code['id'] ? 'selected' : '' ?>>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" name="description" id="description" required value="<?= esc($jobCost['description']) ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="cost_date" id="cost_date" required value="<?= $jobCost['cost_date'] ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div>
                    ...
                    <input type="number" step="0.01" name="quantity" id="quantity" required value="<?= $jobCost['quantity'] ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" onchange="calculateTotal()">
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" name="unit_cost" id="unit_cost" required value="<?= $jobCost['unit_cost'] ?>" class="w-full pl-8 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" onchange="calculateTotal()">
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" name="vendor_supplier" id="vendor_supplier" value="<?= esc($jobCost['vendor_supplier']) ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="reference_number" id="reference_number" value="<?= esc($jobCost['reference_number']) ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <select name="cost_category" id="cost_category" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        <?php foreach ($costCategories as $key => $label): ?>
                            <option value="<?= $key ?>" <?= $jobCost['cost_category'] == $key ? 'selected' : '' ?>>
                                <?= $label ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="flex items-end pb-2">
                    <label class="flex items-center">
                        <input type="checkbox" name="is_billable" value="1" <?= $jobCost['is_billable'] ? 'checked' : '' ?> class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">

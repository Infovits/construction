...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Duplicate Role</h1>
            <p class="text-gray-600">Create a new role based on: <?= esc($role['name']) ?></p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="name" value="<?= old('name', $role['name'] . ' Copy') ?>" required
                ...
                <div>
                    ...
                    <input type="text" name="slug" value="<?= old('slug', $role['slug'] . '_copy') ?>" required
